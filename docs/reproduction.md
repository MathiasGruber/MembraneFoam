...
below 5e-12 for every listed case. The seven-inlet, 45° case uses 1,080,400 cells
and gives 11.776103 kg/(m² h), 1.2% below the archived 11.92. Its salt imbalance
is 0.00945%, with relative mass imbalance below 3e-12.
...
are excluded from steady paper comparisons. Establish a suitable averaging
