...
#include "DarcyForchheimerSaltTransport.H"
...
namespace Foam
{
    ...
    {
        defineTypeNameAndDebug(DarcyForchheimerSaltTransport, 0);
        addToRunTimeSelectionTable(porosityModel, DarcyForchheimerSaltTransport, mesh);
    }
}
...
Foam::porosityModels::DarcyForchheimerSaltTransport::DarcyForchheimerSaltTransport
(
    const word& name,
...
void Foam::porosityModels::DarcyForchheimerSaltTransport::calcForce
(
...
void Foam::porosityModels::DarcyForchheimerSaltTransport::correct
(
    fvVectorMatrix& UEqn
) const
{
    ...
    if (UEqn.dimensions() == dimForce)
    {
        ...
        // In this model we use the viscosity as determined by the salt conc.
        // const volScalarField& mu =
...
bool Foam::porosityModels::DarcyForchheimerSaltTransport::writeData(Ostream& os) const
{
